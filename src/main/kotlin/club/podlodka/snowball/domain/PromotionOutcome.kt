 ...
 *
 * `gross_profit` is a `BigDecimal` because the schema declares an unbounded JSON number and
 * `docs/market-simulator/README.md` computes money at scale 2. `Double` would both lose precision
